...
async function handlePaymentCallback(req, res) {
    try {
        ...
        if (!success || pending || is_refunded || is_refund) {
            console.log('[Payment Callback] Not processed:', { success, pending, is_refunded, is_refund })
        ...
        console.log(`✅ Payment processed: ${userEmail} +${creditsToAdd} credits. Balance: ${newBalance}`)
