...
import { Menu, X, Search, Plus, Home, BookOpen, Loader2 } from 'lucide-react'
            ...
            <div className="px-4 py-4 space-y-2">
              <Link
                ...
                className={`flex items-center gap-3 px-4 py-3 font-medium ${
                  location.pathname === '/' ? 'bg-black text-white' : 'hover:bg-gray-100'
                }`}
              >
                <Home size={20} />
                <span>Home</span>
              ...
              <Link
                to="/guides"
                className={`flex items-center gap-3 px-4 py-3 font-medium ${
                  location.pathname.startsWith('/guide') ? 'bg-black text-white' : 'hover:bg-gray-100'
                }`}
              >
                <BookOpen size={20} />
