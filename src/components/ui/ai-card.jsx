    ...
    useEffect(() => {
        ...
        const animateCircles = () => {
            ...
            circles.forEach((circle, index) => {
                setTimeout(() => {
                    circle.style.transform = 'translateY(-4px) scale(1.1)';
                    setTimeout(() => {
...
export const Card = ({ className, children }) => {
    return (
        <div
            className={cn(
                "max-w-sm w-full mx-auto p-8 rounded-xl border border-white/10 bg-black/70 shadow-[2px_4px_16px_0px_rgba(248,248,248,0.06)_inset] group",
                className
            )}
        >
            {children}
    ...
    return (
        <div
            className={cn(
                ...
                className,
                showGradient && "bg-black/50 [mask-image:radial-gradient(50%_50%_at_50%_50%,white_0%,transparent_100%)]"
            )}
        >
            {children}
        </div>
...
const Container = ({ className, children }) => {
    return (
        <div
            className={cn(
                `h-16 w-16 rounded-full flex items-center justify-center bg-white/5
