...
import { ArrowLeft, Calendar, Tag, Edit2, Trash2, Share2, Copy, Check, Loader2, ExternalLink } from 'lucide-react'
...
export default function GuidePage() {
  ...
  function renderContent() {
    ...
    // If HTML content exists, render in iframe
...
<body>
  ${guide.html_content}
      ...
      return (
        <iframe
          srcDoc={fullHTML}
          className="w-full min-h-[600px] border-2 border-black"
