...
import { adsApi, guidesApi, initializeSampleData, type Ad, type Guide } from "../lib/api";
...
export default function HomePage() {
    ...
    const recentGuides: Guide[] = Array.isArray(allGuides) ? allGuides.slice(0, 6) : [];
                    ...
                    <div className="grid md:grid-cols-2 lg:grid-cols-4 gap-6">
                        ...
                        <div className="p-6 sm:p-8 border border-white/10 bg-black/70 rounded-xl hover:border-white/30 transition-all">
                            ...
                            <p className="text-neutral-400">
                                Write guides in Markdown with full formatting support. Code
                                blocks, lists, headers, and more.
                            </p>
                        </div>
                        <div className="p-6 sm:p-8 border border-white/10 bg-black/70 rounded-xl hover:border-white/30 transition-all">
                            <div className="w-12 h-12 bg-white flex items-center justify-center mb-4 rounded-lg">
                            ...
                            <p className="text-neutral-400">
                                AI-powered search that understands context. Find exactly what
                                you need in seconds.
                            </p>
                        </div>
                        <div className="p-6 sm:p-8 border border-white/10 bg-black/70 rounded-xl hover:border-white/30 transition-all">
                            ...
                            <p className="text-neutral-400">
                                Need more control? Use raw HTML and CSS to create rich,
                                interactive guides.
                            </p>
                        </div>
                    </div>
            ...
            <section className="py-12 sm:py-20">
                <div className="max-w-7xl mx-auto px-4">
                    <div className="flex items-center justify-between mb-8">
                        ...
                        >
                            <ComicText fontSize={2}>View all</ComicText>
                            <ArrowRight size={18} />
                        </Link>
                    </div>
                                    ...
                                    {guide.keywords && guide.keywords.length > 0 && (
                                        <div className="flex flex-wrap gap-2">
                                            {guide.keywords.slice(0, 3).map((kw: string, i: number) => (
                                                <span
                                                    key={i}
                                                    className="px-2 py-1 bg-gray-100 text-xs font-medium"
                                                >
                                                    {kw}
                                                </span>
                                            ))}
