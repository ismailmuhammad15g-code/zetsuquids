          ...
          <form onSubmit={handleSubmit} className="p-8 space-y-8">
            ...
            <div className="space-y-6">
              ...
              <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                ...
                <div>
                  <label className="block text-sm font-bold text-gray-700 mb-1">Regular Price (USD) *</label>
                  ...
                  <p className="text-xs text-gray-500 mt-1">For personal use, end users not charged.</p>
                </div>

                <div>
                  <label className="block text-sm font-bold text-gray-700 mb-1">Extended Price (USD)</label>
                  <div className="relative">
                    <span className="absolute left-3 top-1/2 -translate-y-1/2 text-gray-500 font-medium">$</span>
                    <input name="extended_price" value={formData.extended_price} onChange={handleChange} type="number" step="0.01" min="0" className="w-full pl-8 pr-4 py-2 border border-gray-300 rounded-lg focus:ring-2 focus:ring-indigo-500 outline-none" placeholder="99.00" />
                  </div>
                  <p className="text-xs text-gray-500 mt-1">For commercial use, end users can be charged.</p>
                </div>
              </div>
            </div>
