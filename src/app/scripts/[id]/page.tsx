                ...
                {activeTab === 'details' && (
                  <div className="prose max-w-none text-[#636e72]">
                    ...
                    {script.github_repo_url && hasPurchased && (
                      <div className="mt-8 p-5 bg-[#f8f6f4] border border-[#c8b6a6]/20 rounded-[2px] flex items-center justify-between">
                        <div className="flex items-center gap-4">
                          <div className="p-2 bg-[#fefefe] rounded-[2px] border border-[#c8b6a6]/15">
                            <Github className="text-[#2d3436]" size={24} />
                          </div>
                          <div>
                            <p className="font-heading font-semibold text-[#2d3436] text-sm">Source Code Access</p>
                            <p className="text-xs text-[#636e72]">You have full access to the repository.</p>
                          </div>
                        </div>
                        <a href={script.github_repo_url} target="_blank" rel="noopener noreferrer" className="bg-[#2d3436] hover:bg-[#636e72] text-[#fefefe] px-5 py-2 rounded-[2px] font-medium text-xs transition-colors">
                          Open GitHub
                        </a>
                      </div>
                    )}
                    ...
                    {script.download_url && hasPurchased && (
                      <div className="mt-8 p-5 bg-[#f8f6f4] border border-[#c8b6a6]/20 rounded-[2px] flex items-center justify-between">
                        <div className="flex items-center gap-4">
                          <div className="p-2 bg-[#fefefe] rounded-[2px] border border-[#c8b6a6]/15">
                            <FileCode className="text-[#636e72]" size={24} />
                          </div>
                          <div>
                            <p className="font-heading font-semibold text-[#2d3436] text-sm">Download Script Files</p>
                            <p className="text-xs text-[#636e72]">Download the complete script as a ZIP file.</p>
                          </div>
                        </div>
                        <a href={script.download_url} download className="bg-[#2d3436] hover:bg-[#636e72] text-[#fefefe] px-5 py-2 rounded-[2px] font-medium text-xs transition-colors flex items-center gap-2">
