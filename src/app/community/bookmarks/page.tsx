        ...
        <div className="flex flex-col">
            ...
            {!user ? (
                <div className="flex flex-col items-center justify-center flex-1 px-8 py-20 text-center">
                    ...
                    <button onClick={() => router.push("/auth")} className="bg-[#1d9bf0] hover:bg-[#1a8cd8] text-white font-bold px-8 py-3 rounded-full text-[17px] transition-all hover:shadow-[0_0_20px_rgba(29,155,240,0.4)]">
                        Sign in to bookmark
                    </button>
                </div>
            ) : loading ? (
