"use client";
import { AlertTriangle, ArrowLeft, CheckCircle, DollarSign, FileText, Scale, Shield } from 'lucide-react'
        ...
        <div className="min-h-screen bg-white">
            ...
            <div className="bg-gradient-to-br from-yellow-50 to-amber-50 border-b border-yellow-200">
                <div className="max-w-4xl mx-auto px-6 py-12">
                    <Link href="/" className="inline-flex items-center gap-2 text-yellow-700 hover:text-yellow-900 mb-6 font-medium transition-colors">
                        <ArrowLeft size={20} />
                        Back to Home
                    </Link>
                    ...
                    <section className="mb-12">
                        <div className="bg-gradient-to-br from-gray-900 to-gray-800 text-white rounded-2xl p-8 text-center">
                            ...
                            <div className="flex flex-col sm:flex-row gap-4 justify-center items-center">
                                ...
                                <Link href="/support" className="px-6 py-3 bg-white/10 border border-white/20 text-white font-medium rounded-xl hover:bg-white/20 transition-colors">
                                    Support Center
                                </Link>
                            </div>
                        </div>
            ...
            <div className="bg-gray-50 border-t border-gray-200 py-8">
                <div className="max-w-4xl mx-auto px-6 text-center">
                    <p className="text-sm text-gray-600">
                        ...
                        <Link href="/privacy" className="text-yellow-600 hover:underline font-medium">Privacy Policy</Link>
                    </p>
                </div>
            </div>
        </div>
