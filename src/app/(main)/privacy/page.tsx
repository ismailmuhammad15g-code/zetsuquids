"use client";
import { ArrowLeft, CreditCard, Database, Eye, Lock, Mail, MessageSquare, Shield } from 'lucide-react'
            ...
            <div className="bg-gray-50 border-t border-gray-200 py-8">
                <div className="max-w-4xl mx-auto px-6 text-center">
                    <p className="text-sm text-gray-600">
                        ...
                        <Link href="/terms" className="text-yellow-600 hover:underline font-medium">Terms of Service</Link>
                    </p>
                </div>
            </div>
        </div>
