...
export default function ReportBugPage() {
    ...
    const locationState = null as ReportBugLocationState | null
        ...
        return (
            <div className="min-h-screen bg-black text-white flex items-center justify-center p-6 relative overflow-hidden">
                ...
                <div className="max-w-md w-full text-center space-y-8 animate-in fade-in zoom-in duration-700 relative z-10">
                    ...
                    <div className="pt-4">
                        <Link href="/" className="px-10 py-4 bg-white text-black font-black uppercase tracking-wider rounded-xl hover:bg-gray-200 transition-all transform hover:scale-105 inline-block shadow-lg shadow-white/10">
                            Return to Base
                        </Link>
                    </div>
                </div>
